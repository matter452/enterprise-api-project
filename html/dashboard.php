        ...
        <div class="flex flex-wrap justify-center">
            ...
            <form id="search" method="GET" action="" class="flex flex-col basis-1/4">
                <fieldset class="flex flex-row flex-wrap border border-slate-400 my-2 rounded-md p-4 gap-x-2">
                    ...
                    <input type="radio" id="loan_radio" class="form-radio" name="search_by" value="loan_radio" required/>
                    <label for="loan_radio">Document Type</label>
                    <input type="radio" id="document_radio" class="form-radio" name="search_by" value="document_radio" required/>
                </fieldset>
                ...
                <button id="search_button" type="button" class="bg-sky-700 text-slate-100 text-center rounded-md py-2" 
